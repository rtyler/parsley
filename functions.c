...
{
  xsltRegisterExtModuleFunction ((const xmlChar *) "html-document",
                                 "http://parselets.com/stdlib",
                                 xsltHtmlDocumentFunction);
  xsltRegisterExtModuleFunction ((const xmlChar *) "outer-xml",
                                 "http://parselets.com/stdlib",
                                 xsltOuterXmlFunction);
  xsltRegisterExtModuleFunction ((const xmlChar *) "inner-xml",
                                 "http://parselets.com/stdlib",
...
static void
xsltHtmlDocumentFunctionLoadDocument (xmlXPathParserContextPtr ctxt,
                                      xmlChar * URI)
{
  xsltTransformContextPtr tctxt;
  xmlURIPtr uri;
...
xsltLoadHtmlDocument (xsltTransformContextPtr ctxt, const xmlChar * URI)
{
  ...
  doc =
    htmlReadFile (URI, NULL,
                  ctxt->parserOptions | HTML_PARSE_RECOVER |
