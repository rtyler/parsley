...
static struct argp_option options[] = {
  ...
  {"include", 'i', "FILE", 0,
   "Include the contents of FILE in the compiled XSLT"},
...
main (int argc, char **argv)
{
  ...
  arguments.flags =
    ~0 & ~PARSLEY_OPTIONS_SGWRAP & ~PARSLEY_OPTIONS_FORCE_UTF8;
  ...
  parsedParsleyPtr ptr =
    parsley_parse_file (compiled, arguments.input_file, arguments.flags);
