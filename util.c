...
xmlDocPtr parsley_apply_span_wrap(xmlDocPtr doc)
{
...
static void *xmlUserAgentIOHTTPOpen(const char *file_name)
{
...
void parsley_io_set_mode(int mode)
{
    ...
    if (parsley_io_mode & PARSLEY_OPTIONS_ALLOW_NET)
    {
        ...
        xmlRegisterInputCallbacks(xmlIOHTTPMatch, xmlUserAgentIOHTTPOpen, xmlIOHTTPRead, xmlIOHTTPClose);
...
static xmlNodePtr _xmlLastElementChild(xmlNodePtr node)
{
